# Ribaal Editorial Storefront

A self-contained, share-ready Next.js implementation of the Ribaal luxury sherwani homepage.

## Included

- Sticky Ribaal header with expanding search, login preview and collapsible navigation curtain.
...
- Eight original runtime assets in public/Ribaal.
...
- app/RibaalHome.tsx — sections, interactions and scroll-animation lifecycle.
- app/Ribaal.module.css — the complete isolated design system.
- public/Ribaal — photography, collection sprite and repeatable SVG patterns.
- tests/bundle.test.mjs — source, dependency and asset-integrity checks.

## Integration boundaries

Search feedback and account login are frontend previews. Replace the Ribaal.example metadata/contact values and connect real catalog, authentication and destination routes before production use.
